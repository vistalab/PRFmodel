function pmEllipse_Fig3_TestMode
% Make Figure 3 TestMode
%
%
% See also
...
for nslvl = noiselevel
    fnameRoot = sprintf('Fig3-TestMode_R1_CloudPlots4x4_Noise-%s_Size-%i', nslvl{:}, userfsize);
    ...
    tt = A.compTable.afni6(A.compTable.noiseLevel==string(nslvl{:}) & ...
        ...
        A.compTable.synth.x0==3 & ...
        A.compTable.synth.y0==3,:);
