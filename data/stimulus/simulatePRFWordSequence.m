...
% The "scan" is divided into "blocks" of 15 "trials." Each trial is 2.8 s long,
% with a word flashing briefly at a random location at the beginning of the trial. 
% After each "block", there is a 12.6s blank period. 
%
...
showMovie = true; %whether to play a 'movie' of the stimulus sequence
...
for ni = 1:numNumLocs
    ...
    %imageSeq: HxWxT
    imageSeq = zeros(imageSizePx, imageSizePx, totalDur);
    
    %counter of which TR we're at. start after innitial blank
    trI = initialBlankDur+1;
    ...
    for bi=1:numBlocks
        ...
        for ti=1:trialsPerBlock
            ...
            imageSeq(:,:,(trI:(trI+stimDur-1))) = locImages(:,:,locOrder(trialNum));
