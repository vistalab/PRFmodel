function synthBOLDgenerator(json)
...
%     3/ StimulusFor_name.nii.gz: nifti file with the stimulus used to generate the BOLD tSeries
% 
% 
% REQUIRED INPUTS:
...
%{
    % Create files
    jsonParams = fullfile(pmRootPath,'gear','synthBOLDgenerator_paramsExample.json');
    synthBOLDgenerator(jsonParams);

    % Run the analysis
    results = pmModelFit({'synthBOLD_20190917T222512/synthBOLD.nii.gz', ...
                          'synthBOLD_20190917T222512/synthBOLD.json', ...
                          'synthBOLD_20190917T222512/synthBOLD_Stimulus.nii.gz'}, ...
                          'aPRF');
%}
...
% STIM FILE
stimNiftiFname = [J.fileName '_Stimulus.nii.gz'];
pm1            = synthDT.pm(1);
