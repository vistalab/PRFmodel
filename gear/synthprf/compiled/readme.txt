...
================================
-synthBOLDgenerator 
-run_synthBOLDgenerator.sh (shell script for temporarily setting environment variables 
                            and executing the application)
   -to run the shell script, type
   
       ./run_synthBOLDgenerator.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v95, run the shell script as:
       ...
       ./run_synthBOLDgenerator.sh /mathworks/home/application/v95
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_synthBOLDgenerator.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v95/runtime/glnxa64:MR/v95/bin/glnxa64:MR/v95/sys/os/glnxa64:MR/v95/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_synthBOLDgenerator.sh 
