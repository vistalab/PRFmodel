...
================================
-prfanalyze_aprf 
-run_prfanalyze_aprf.sh (shell script for temporarily setting environment variables and 
                         executing the application)
   -to run the shell script, type
   
       ./run_prfanalyze_aprf.sh <mcr_directory> <argument_list>
    ...
    /mathworks/home/application/v99, run the shell script as:
       ...
       ./run_prfanalyze_aprf.sh /mathworks/home/application/v99
       
    If you have MATLAB installed in /mathworks/devel/application/matlab, 
    run the shell script as:
    
       ./run_prfanalyze_aprf.sh /mathworks/devel/application/matlab
-MCRInstaller.zip
...
${LD_LIBRARY_PATH}:MR/v99/runtime/glnxa64:MR/v99/bin/glnxa64:MR/v99/sys/os/glnxa64:MR/v99/sys/opengl/lib/glnxa64
   ...
   Distribute in the MATLAB Compiler documentation in the MathWorks Documentation Center.
        ...
        NOTE: When deploying standalone applications, you can
              run the shell script file run_prfanalyze_aprf.sh 
