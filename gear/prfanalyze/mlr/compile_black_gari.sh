...
addpath(genpath('/data/localhome/glerma/soft/mrtools'));
addpath(genpath('/data/localhome/glerma/soft/gru'));

mcc -m -R -nodisplay -a /data/localhome/glerma/toolboxes/PRFmodel/data -d compiled prfanalyze_mlr.m 
exit
END
